...
public OnPluginStart()
{
    ...
    //Custom forward for other plugins to use.
    
    g_hApplyAttributes = CreateGlobalForward("ZR_OnClientClassApply", ET_Event, Param_Cell); //fired when trying to apply class playermodel.
}
